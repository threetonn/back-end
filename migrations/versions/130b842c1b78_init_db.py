...
Revision ID: 130b842c1b78
Revises: 
Create Date: 2022-11-01 13:58:18.589317
...
def upgrade() -> None:
    ...
    sa.Column('SubscriptionType_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['SubscriptionDuration_id'], ['subscriptionduration.id'], ),
    sa.ForeignKeyConstraint(['SubscriptionType_id'], ['subscriptiontype.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_subscription_SubscriptionDuration_id'), 'subscription', ['SubscriptionDuration_id'], unique=False)
    op.create_index(op.f('ix_subscription_SubscriptionType_id'), 'subscription', ['SubscriptionType_id'], unique=False)
    ...
    op.create_table('subscription_has_features',
    sa.Column('Subscription_id', sa.Integer(), nullable=False),
    sa.Column('Features_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['Features_id'], ['features.id'], ),
    sa.ForeignKeyConstraint(['Subscription_id'], ['subscription.id'], ),
    sa.PrimaryKeyConstraint('Subscription_id', 'Features_id')
    )
    op.create_index(op.f('ix_subscription_has_features_Features_id'), 'subscription_has_features', ['Features_id'], unique=False)
    op.create_index(op.f('ix_subscription_has_features_Subscription_id'), 'subscription_has_features', ['Subscription_id'], unique=False)
    op.create_table('user_has_workouttype',
    sa.Column('User_id', sa.Integer(), nullable=False),
    sa.Column('WorkoutType_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['User_id'], ['user.id'], ),
    sa.ForeignKeyConstraint(['WorkoutType_id'], ['workouttype.id'], ),
    sa.PrimaryKeyConstraint('User_id', 'WorkoutType_id')
    )
    op.create_index(op.f('ix_user_has_workouttype_User_id'), 'user_has_workouttype', ['User_id'], unique=False)
    op.create_index(op.f('ix_user_has_workouttype_WorkoutType_id'), 'user_has_workouttype', ['WorkoutType_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_user_has_workouttype_WorkoutType_id'), table_name='user_has_workouttype')
    op.drop_index(op.f('ix_user_has_workouttype_User_id'), table_name='user_has_workouttype')
    op.drop_table('user_has_workouttype')
    op.drop_index(op.f('ix_subscription_has_features_Subscription_id'), table_name='subscription_has_features')
    op.drop_index(op.f('ix_subscription_has_features_Features_id'), table_name='subscription_has_features')
    op.drop_table('subscription_has_features')
    op.drop_index(op.f('ix_user_Role_id'), table_name='user')
    op.drop_index(op.f('ix_user_Gender_id'), table_name='user')
    op.drop_table('user')
    op.drop_index(op.f('ix_subscription_SubscriptionType_id'), table_name='subscription')
